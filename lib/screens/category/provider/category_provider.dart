import 'dart:io';
import 'dart:math';
import 'package:ecommerce/models/api_response.dart';
import 'package:ecommerce/utility/snack_bar_helper.dart';
  ...
  deleteCategory(Category category) async {
    try {
      ...
      if (response.isOk) {
        ApiResponse apiResponse = ApiResponse.fromJson(response.body, null);
        if (apiResponse.success == true) {
          SnackBarHelper.showSuccessSnackBar('Categoria Excluída com Sucesso');
          _dataProvider.getAllCategory();
        }
      } else {
        SnackBarHelper.showErrorSnackBar(
