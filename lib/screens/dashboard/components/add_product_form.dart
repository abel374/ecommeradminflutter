  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        title: Center(
            child: Text('Adicionar produto'.toUpperCase(),
